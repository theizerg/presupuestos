<!DOCTYPE html>
    ...
    <head>
        ...
        <title>SAPCPV - @yield('title')</title>
                ...
                <li class="dropdown user user-menu" >
                    ...
                    <li class="user-header blue darken-4">
                       <!-- <img src="{{ asset('images/user/user1-128x128.jpg') }}" class="img-circle" alt="User Image">-->
                        ...
                        {{ Auth::user()->full_name }}
                        <br>
                        {{ Auth::user()->hasrole('Administrador') ? 'Supervisor Nacional' : 'Usuario' }}
    ...
    <!-- /.navbar -->
        ...
        <footer class="main-footer">
            ...
            <img src="{{asset('images/fondo/logo-vertical.png')}}" alt="AdminLTE Logo" height="20" style="opacity: .8">
            </div>
