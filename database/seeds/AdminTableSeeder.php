...
class AdminTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('monedas')->insert([
         ...
         \DB::table('clase_servicios')->insert([
            'nombre' => 'Reparación de bomba de gasolina'
        ]);
         ...
         \DB::table('clase_servicios')->insert([
            'nombre' => 'Reparación de pastilla de frenos'
        ]);
        ...
        \DB::table('clase_servicios')->insert([
         ...
         \DB::table('clase_servicios')->insert([
            'nombre' => 'Cambio de tripoide'
        ]);

          \DB::table('clase_servicios')->insert([
            'nombre' => 'Cambio de pastilla de frenos'
        ]);
