	...
	$('#btnBuscarCliente').on('click', function(e) {
		...
		$.get(url , function( data ){			    
			...
			for(i=0; i < clientes.length; i++){
				...
				var cliente_marca_vehiculo = "";
				if(clientes[i]["marca_vehiculo"] != null){
					var cliente_marca_vehiculo = clientes[i]["marca_vehiculo"];	
				}
				var cliente_ano_vehiculo = "";
				if(clientes[i]["ano_vehiculo"] != null){
					var cliente_ano_vehiculo = clientes[i]["ano_vehiculo"];	
				}
				var cliente_placa_vehiculo = "";
				if(clientes[i]["placa_vehiculo"] != null){
					var cliente_placa_vehiculo = clientes[i]["placa_vehiculo"];	
				}
				...
				$("#tablaClientes").append(
					$('<tr></tr>').html(
						...
						"<td class='td_cliente_nombre'>" 
							+ cliente_nombre
						+ "</td><td class='td_cliente_marca_vehiculo'>"
							+ cliente_marca_vehiculo
						+ "</td><td class='td_cliente_ano_vehiculo'>"
							+ cliente_ano_vehiculo
						+ "</td><td class='td_cliente_placa_vehiculo'>"
							+ cliente_placa_vehiculo							
